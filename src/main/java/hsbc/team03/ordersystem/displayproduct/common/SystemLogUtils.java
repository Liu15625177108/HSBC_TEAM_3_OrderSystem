...
public class SystemLogUtils {
    ...
    public static List<Log> screeningSystemLog(int n, List<Log> logList) throws ParseException {
        /*得到当前时间并转换成时间类型*/
    ...
    public static String exportSystomLogToExcel(List<Log> logs, HttpServletResponse response) throws IOException {
